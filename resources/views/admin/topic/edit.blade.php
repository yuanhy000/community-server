...
<div class="container">
    <div class="position-container">
        ...
        <a href="{{url('admin/info')}}">首页</a>&raquo;&nbsp;&nbsp;<a href="{{url('admin/topic')}}">主题管理</a>&raquo; <span>编辑主题</span>
    </div>
            ...
            <div class="content-container">
                <div class="left-container">
                    ...
                    <div class="form-item">
                        ...
                        <input type="text" class="item-input" name="name" value="{{$topic->name}}">
                    </div>
                    <div class="form-item">
                        <div class="item-name">
                            主题描述
                        </div>
                        <textarea type="text" class="item-textare" name="description">{{$topic->description}}</textarea>
                    </div>
                </div>
                <div class="right-container">
                    ...
                    <div class="form-item">
                        <div class="item-name">上传主题缩略图：</div>
                        <div id="ossfile">你的浏览器不支持flash,Silverlight或者HTML5！</div>
                        <img src="{{$topic->image->url}}" alt="" id="topic-image">
                        <div id="container">
